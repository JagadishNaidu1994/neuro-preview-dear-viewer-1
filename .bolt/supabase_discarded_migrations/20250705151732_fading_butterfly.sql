/*
  ...
  This migration creates all the necessary tables and relationships that are missing from the database:
...
CREATE POLICY "Admins can view admin users"
  ...
  USING (EXISTS (
    ...
    WHERE admin_users_1.user_id = uid()
  ));
...
CREATE POLICY "Users can view own order items"
  ...
  USING (EXISTS (
    ...
    WHERE orders.id = order_items.order_id AND orders.user_id = uid()
  ));
...
CREATE POLICY "Users can view own referrals"
  ...
  FOR SELECT
  TO authenticated
  USING (referrer_id = uid() OR referee_id = uid());
...
SELECT 
  'Sample Product 2',
  'Another sample product for testing the application.',
  39.99,
  'https://images.pexels.com/photos/3683108/pexels-photo-3683108.jpeg',
  'supplements',
  25,
  true
