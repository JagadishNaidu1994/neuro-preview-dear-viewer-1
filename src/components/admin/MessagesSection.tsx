...
const MessagesSection = () => {
  ...
  const getStatusBadge = (status: string) => {
    switch (status) {
      case 'unread': return <Badge className="bg-orange-100 text-orange-800 text-xs">New</Badge>;
      case 'read': return null;
      case 'replied': return <Badge className="bg-green-100 text-green-800 text-xs">Replied</Badge>;
      default: return null;
    }
  };
            ...
            {filteredMessages.map((contact) => (
              <div
                ...
                className={`flex items-center gap-3 p-3 rounded-lg cursor-pointer transition-colors ${
                  selectedContact?.id === contact.id ? 'bg-blue-50 border-l-4 border-blue-500' : 'hover:bg-gray-50'
                }`}
              >
              ...
              <div className="flex items-center gap-4">
                ...
                <div className="flex items-center gap-4 text-sm">
                  <div className="flex flex-col items-center">
                    <span className="font-medium">#2564</span>
                    <span className="text-gray-500">Draft</span>
                  </div>
                  <div className="flex flex-col items-center">
                    <span className="font-medium">#2563</span>
                    <span className="text-gray-500">Blocked</span>
                  </div>
                  <div className="flex flex-col items-center">
                    <span className="font-medium">#2562</span>
                    <span className="text-gray-500">Spam</span>
                  </div>
                  <div className="flex flex-col items-center">
                    <span className="font-medium text-orange-600">#2564</span>
                    <span className="text-orange-600">Refund</span>
                  </div>
                  <div className="flex flex-col items-center">
                    <span className="font-medium">#2558</span>
                    <span className="text-gray-500">Completed</span>
                  </div>
                  <div className="flex flex-col items-center">
                    <span className="font-medium">#4564</span>
