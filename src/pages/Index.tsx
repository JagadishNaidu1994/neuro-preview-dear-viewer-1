            ...
            backgroundRepeat: "no-repeat"
              ...
              <div className="absolute bottom-6 left-6 md:bottom-10 md:left-10 w-[calc(100%-48px)] md:w-[470px]">
                <div className="space-y-4 md:space-y-5">
                  ...
                  <Link to="/shop-all">
                    <Button variant="outline" className="border-2 border-white text-white bg-transparent hover:bg-white hover:text-black rounded-2xl px-4 py-2 md:px-6 md:py-3 opacity-70 hover:opacity-100 transition-all text-sm">
          ...
          <section className="space-y-4">
              ...
              <div className="bg-[#EEEEEA] rounded-[20px] relative overflow-hidden h-[400px] lg:h-full">
                <div className="h-full flex flex-col justify-center items-center relative">
                  ...
                  <div className="absolute bottom-12 md:bottom-16 left-1/2 transform -translate-x-1/2 bg-[#C2C2C2] rounded-[10px] px-3 py-3 flex gap-1">
                    {carouselItems.map((_, index) => <div key={index} className={`w-1 h-1 rounded-full transition-colors duration-300 ${index === currentSlide ? 'bg-[#3D3D3D]' : 'bg-[#F6F6F6]'}`} />)}
                  </div>
                </div>
              </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 md:gap-12 min-h-auto lg:min-h-[785px] items-center">
              <div className="flex flex-col justify-center items-start lg:items-end space-y-6 order-2 lg:order-1">
                ...
                <Link to="/the-science">
                  <Button variant="outline" className="border-2 border-[#161616] text-[#161616] bg-transparent hover:bg-[#161616] hover:text-white rounded-2xl px-6 py-3">
                    Our Science
                  </Button>
                </Link>
              </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 md:gap-20 min-h-auto lg:min-h-[928px] items-center">
              ...
              <div className="flex flex-col justify-center space-y-6">
                ...
                <Link to="/ethos">
                  <Button variant="outline" className="border-2 border-[#161616] text-[#161616] bg-transparent hover:bg-[#161616] hover:text-white rounded-2xl px-6 py-3 w-fit">
                    Our Ethos
                  </Button>
                </Link>
              </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 md:gap-16 mb-8 md:mb-16">
            ...
            <div className="lg:col-span-2 grid grid-cols-2 gap-8 md:gap-20">
              <div className="space-y-3">
                <Link to="/shop-all" className="block text-xs text-black hover:underline">
                  Shop All
                </Link>
                <Link to="/the-science" className="block text-xs text-black hover:underline">
                  The Science
                </Link>
                <Link to="/ethos" className="block text-xs text-black hover:underline">
                  Our Ethos
                </Link>
                <Link to="/herbal-index" className="block text-xs text-black hover:underline">
                  Herbal Index
                </Link>
                <div className="pt-6 md:pt-10">
                  <Link to="/privacy" className="block text-[9px] text-black hover:underline">
                    Privacy & Cookies Policy
                  </Link>
                </div>
              </div>
              <div className="space-y-3">
                <Link to="/faqs" className="block text-xs text-black hover:underline">
                  FAQs
                </Link>
                <Link to="/shipping" className="block text-xs text-black hover:underline">
                  Shipping & Returns
                </Link>
                <Link to="/terms" className="block text-xs text-black hover:underline">
                  Terms & Conditions
                </Link>
                <Link to="/contact" className="block text-xs text-black hover:underline">
                  Contact Us
                </Link>
                <div className="pt-6 md:pt-10">
                  <Link to="/accessibility" className="block text-[9px] text-black hover:underline">
