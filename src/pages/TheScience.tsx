...
const TheScience = () => {
  return <div className="min-h-screen bg-[#F8F8F5] text-[#1E1E1E]">
      <Header />

      {/* Intro Section */}
      <main className="w-full px-4 pt-16 space-y-24 pb-32">
        <div className="max-w-[1400px] mx-auto">
          ...
          <section className="flex flex-col md:flex-row items-center gap-10">
            ...
            <div className="flex-1">
              <img src="/images/thescience/header-image.webp" alt="Science overview" className="w-full rounded-lg" />
            </div>
          </section>
          ...
          }].map((item, idx) => <div key={idx} className="group bg-white rounded-xl overflow-hidden shadow-sm hover:shadow-md transition-all duration-300">
          ...
          <section className="text-center space-y-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              ...
              image: "/images/thescience/doc1.jpg"
            }, {
              name: "Dr. Christine Wong, PhD",
              image: "/images/thescience/doc2.jpg"
            }, {
              name: "Dr. Riley Chen, MD",
              image: "/images/thescience/doc1.jpg"
            }].map(doc => <div key={doc.name}>
          ...
          <section className="w-full">
            <img src="/images/thescience/gummies-blocks.webp" alt="Gummies block" className="rounded-xl w-full" />
          </section>
          ...
          <section>
            ...
            <div className="flex items-start gap-10 flex-col md:flex-row">
              ...
              <div className="flex-1">
                <img src="/images/thescience/gummy-hand.webp" alt="Gummy on hand" className="rounded-xl" />
              </div>
            </div>
          </section>
