      ...
      <main className="max-w-[1905px] mx-auto px-4 md:px-8 pt-8">
        <div className="text-center py-12 md:py-16">
          ...
          <p className="text-[#231F20] text-lg md:text-xl font-normal mt-6 max-w-[600px] mx-auto">
            Discover our complete collection of premium mushroom-based wellness products
          </p>
        </div>
          ...
          {products.map((product) => (
            ...
            >
              ...
              <div className="p-6 bg-white">
                <h3 className="text-[#161616] text-lg font-medium mb-2">{product.name}</h3>
                <p className="text-[#B2AFAB] text-sm mb-4">{product.description}</p>
                ...
                <div className="flex items-center justify-between">
                  <span className="text-[#161616] text-xl font-semibold">{product.price}</span>
                  <Button
                    variant="outline"
