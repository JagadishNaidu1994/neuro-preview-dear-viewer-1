      ...
      <div className="max-w-4xl mx-auto px-4 py-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <div className="lg:col-span-2 space-y-4">
            {items.map(item => <div key={item.id} className="bg-white rounded-lg p-6 shadow-sm flex items-center space-x-4">
                ...
                <div className="flex items-center space-x-2">
                  ...
                  <Input type="number" value={item.quantity} onChange={e => updateQuantity(item.product_id, parseInt(e.target.value) || 1)} className="w-16 text-center" min="1" />
                  <Button size="sm" variant="outline" onClick={() => updateQuantity(item.product_id, item.quantity + 1)}>
                    <FaPlus />
                  </Button>
                </div>
